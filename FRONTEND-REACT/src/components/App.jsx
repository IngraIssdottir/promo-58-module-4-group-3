...
const defaultPojects = [
  {
    ...
    image: "https://i0.wp.com/wherecreativityworks.com/wp-content/uploads/2017/04/unnamed1-e1492372677392.jpg?w=389&h=389&crop=1&ssl=1",
    photo: "https://upload.wikimedia.org/wikipedia/commons/f/f3/Eleonora_van_Aquitani%C3%AB.jpg", // Imagen del proyecto
  },
  {
    id: 2,
    ...
    image: "https://people.com/thmb/TJNzoOAs2THb1GTF708L093uwAw=/1500x0/filters:no_upscale():m[…]401x2)/rocky-horror-01-800-f7d3710af1544d18a214adb198599960.jpg", //Imagen de la autora
  ...
  },
  {
    ...
    job: "Cocinera",
    image: "https://rms-media-prod.generalmills.com/f7eb3602-ac1d-4415-8046-fcefd1107328.jpg", // Imagen de la autora
    photo: "https://pbs.twimg.com/profile_images/643751284353462273/JRJ9kWsE_400x400.jpg" // Imagen del proyecto
  },
  {
    id: 4,
    name: "Letras mágicas",
    ...
    autor: "Miriam Tirado",
    job: "escritora",
    image: " https://cdn.grupoelcorteingles.es/SGFM/dctm/MEDIA03/202103/22/00106540052732____10__1200x1200.jpg?impolicy=Resize&width=900", // Imagen de la Autora
    photo: "https://m.media-amazon.com/images/S/amzn-author-media-prod/imff5o87ma0e3fjpij39j0a873._SY450_CR0%2C0%2C450%2C450_.jpg", // Imaagen del proyecto
  },
];
...
function App() {
  ...
  return (
    <div className="container">
      <Header />
      <Routes>
        <Route path="/" element={<LandingPages projectsLanding={projectsLanding}/>} />
